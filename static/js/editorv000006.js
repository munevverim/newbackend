document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("t2i-generate").addEventListener("click", async function () {
        ...
        for (let i = 1; i <= 4; i++) {
          ...
          imgElement.src = "/static/images/generate-image.gif";
        }
        ...
        try {
            ...
            for (let i = 1; i <= 4; i++) {
                const imgElement = document.getElementById("image" + i).getElementsByTagName("img")[0];
                imgElement.src = "/static/images/GENERATE LOGO.png";
            }
        }
    });
...
function handleImageClick() {
    ...
    images.forEach(function(image, index) {
        image.addEventListener('click', function() {
            var src = image.src;
            if (!src.includes("GENERATE%20LOGO.png") && !src.includes("generate-image.gif")) {
                images.forEach(function(img) {
                    img.style.border = '1px solid #8C8C8C';
                });

                image.style.border = 'thick solid #d6875e';
    ...
    function updatePopupImage() {
        ...
        images[currentIndex].style.border = 'thick solid #d6875e';
...
handleImageClick();
    ...
    var hideImg = document.getElementById('hide-mask').querySelector('img');
    var brushImg = document.getElementById('brush').querySelector('img');
    ...
    document.getElementById("eraser").addEventListener("click", async function () {
        ...
        hideImg.src = "/static/images/icons/mask invisible.png";
        hideImg.style.opacity="0.5";
    });
    ...
    canvas.freeDrawingBrush.color = "rgba(214, 135, 94, 1)";
    ...
    document.getElementById("hide-mask").addEventListener("click", async function () {
      var objects = canvas.getObjects();
      for (var i=0; i < objects.length; i++){
          if(objects[i] instanceof fabric.Path ){
            if (objects[i].visible){
                objects[i].visible = false;
                hideImg.src = "/static/images/icons/mask visible.png";
                hideImg.style.opacity="0.5";
                canvas.isDrawingMode = false;
    ...
    downloadBtn.addEventListener('click', function () {
        downloadCanvasImage(imageCanvas, 'image.png');
    });

    function downloadCanvasImage(imageCanvas, filename) {
        renderCanvas();
        var dataUrl = renderCanvas().imageCanvas.toDataURL('image/png');
    ...
    var fpButton = document.getElementById("floor-plan");
    var lsButton = document.getElementById("landscape");
    var modernimg = document.getElementById("modern-img");
    var ncimg = document.getElementById("neoclassical-img");
    var acimg = document.getElementById("ancient-chinese-img");
    var hellenisticimg = document.getElementById("hellenistic-img");
    var constructivistimg = document.getElementById("constructivist-img");
    var futuristicimg = document.getElementById("futuristic-img");
    var minimalistimg = document.getElementById("minimalist-img");
    var cyberpunkimg = document.getElementById("cyberpunk-img");
    var industrialimg = document.getElementById("industrial-img");
    var gothicimg = document.getElementById("gothic-img");
    var naimg = document.getElementById("native-american-img");
    var baroqueimg = document.getElementById("baroque-img");
    var rococoimg = document.getElementById("rococo-img");
    var bauhausimg = document.getElementById("bauhaus-img");
    var adimg = document.getElementById("art-deco-img");
    var medievalimg = document.getElementById("medieval-img");
    var byzantineimg = document.getElementById("byzantine-img");
    var renaissanceimg = document.getElementById("renaissance-img");
    var ottomanimg = document.getElementById("ottoman-img");
    var victorianimg = document.getElementById("victorian-img");
    var bohemianimg = document.getElementById("bohemian-img");
    var countryimg = document.getElementById("country-img");
    var nordicimg = document.getElementById("nordic-img");
    var w1 = document.getElementById("clear-weather");
    var w2 = document.getElementById("cloudy-weather");
    var w3 = document.getElementById("dusk-weather");
    var w4 = document.getElementById("foggy-weather");
    var w5 = document.getElementById("night-weather");
    var w6 = document.getElementById("rainy-weather");
    var w7 = document.getElementById("snowy-weather");
    var styleDecider = document.getElementById("style-decider");
    var weatherDecider = document.getElementById("weather-decider");

    interiorButton.addEventListener("change", function() {
        styleDecider.style.display = "flex";
        weatherDecider.style.display = "flex";

        if (interiorButton.checked) {
            modernimg.src = "/static/images/styles/1.MODERN/interior.png";
            ncimg.src = "/static/images/styles/2.NEOCLASSIC/interior.png";
            acimg.src = "/static/images/styles/3.CHINESE/interior.png";
            hellenisticimg.src = "/static/images/styles/4.HELLENISTIC/interior.png";
            constructivistimg.src = "/static/images/styles/5.CONSTRUCTIVIST/interior.png";
            futuristicimg.src = "/static/images/styles/6.FUTURISTIC/interior.png";
            minimalistimg.src = "/static/images/styles/7.MINIMALIST/interior.png";
            cyberpunkimg.src = "/static/images/styles/8.CYBERPUNK/interior.png";
            industrialimg.src = "/static/images/styles/9.INDUSTRIAL/interior.png";
            gothicimg.src = "/static/images/styles/10.GOTHIC/interior.png";
            naimg.src = "/static/images/styles/11.NATIVE/interior.png";
            baroqueimg.src = "/static/images/styles/12.BAROQUE/interior.png";
            rococoimg.src = "/static/images/styles/13.ROCOCO/interior.png";
            bauhausimg.src = "/static/images/styles/14.BAUHAUS/interior.png";
            adimg.src = "/static/images/styles/15.ART DECO/interior.png";
            medievalimg.src = "/static/images/styles/16.MEDIEVAL/interior.png";
            byzantineimg.src = "/static/images/styles/17.BYZANTINE/interior.png";
            renaissanceimg.src = "/static/images/styles/18.RENAISSANCE/interior.png";
            ottomanimg.src = "/static/images/styles/19.OTTOMAN/interior.png";
            victorianimg.src = "/static/images/styles/20.VICTORIAN/interior.png";
            bohemianimg.src = "/static/images/styles/21.BOHEMIAN/interior.png";
            countryimg.src = "/static/images/styles/22.COUNTRY/interior.png";
            nordicimg.src = "/static/images/styles/23.NORDIC/interior.png";
            w1.src = "/static/images/weather-icons/sunny.png";
            w2.src = "/static/images/weather-icons/cloudy.png";
            w3.src = "/static/images/weather-icons/dusk.png";
            w4.src = "/static/images/weather-icons/foggy.png";
            w5.src = "/static/images/weather-icons/night.png";
            w6.src = "/static/images/weather-icons/rainy.png";
            w7.src = "/static/images/weather-icons/snowy.png";
        }
    });

    exteriorButton.addEventListener("change", function() {
        styleDecider.style.display = "flex";
        weatherDecider.style.display = "flex";

        if (exteriorButton.checked) {
            modernimg.src = "/static/images/styles/1.MODERN/exterior.png";
            ncimg.src = "/static/images/styles/2.NEOCLASSIC/exterior.png";
            acimg.src = "/static/images/styles/3.CHINESE/exterior.png";
            hellenisticimg.src = "/static/images/styles/4.HELLENISTIC/exterior.png";
            constructivistimg.src = "/static/images/styles/5.CONSTRUCTIVIST/exterior.png";
            futuristicimg.src = "/static/images/styles/6.FUTURISTIC/exterior.png";
            minimalistimg.src = "/static/images/styles/7.MINIMALIST/exterior.png";
            cyberpunkimg.src = "/static/images/styles/8.CYBERPUNK/exterior.png";
            industrialimg.src = "/static/images/styles/9.INDUSTRIAL/exterior.png";
            gothicimg.src = "/static/images/styles/10.GOTHIC/exterior.png";
            naimg.src = "/static/images/styles/11.NATIVE/exterior.png";
            baroqueimg.src = "/static/images/styles/12.BAROQUE/exterior.png";
            rococoimg.src = "/static/images/styles/13.ROCOCO/exterior.png";
            bauhausimg.src = "/static/images/styles/14.BAUHAUS/exterior.png";
            adimg.src = "/static/images/styles/15.ART DECO/exterior.png";
            medievalimg.src = "/static/images/styles/16.MEDIEVAL/exterior.png";
            byzantineimg.src = "/static/images/styles/17.BYZANTINE/exterior.png";
            renaissanceimg.src = "/static/images/styles/18.RENAISSANCE/exterior.png";
            ottomanimg.src = "/static/images/styles/19.OTTOMAN/exterior.png";
            victorianimg.src = "/static/images/styles/20.VICTORIAN/exterior.png";
            bohemianimg.src = "/static/images/styles/21.BOHEMIAN/exterior.png";
            countryimg.src = "/static/images/styles/22.COUNTRY/exterior.png";
            nordicimg.src = "/static/images/styles/23.NORDIC/exterior.png";
            w1.src = "/static/images/weather-icons/sunny.png";
            w2.src = "/static/images/weather-icons/cloudy.png";
            w3.src = "/static/images/weather-icons/dusk.png";
            w4.src = "/static/images/weather-icons/foggy.png";
    ...
    fpButton.addEventListener("change", function() {
        styleDecider.style.display = "none";
        weatherDecider.style.display = "none";
    });

    

    lsButton.addEventListener("change", function() {
        styleDecider.style.display = "none";
        weatherDecider.style.display = "none";
    });
